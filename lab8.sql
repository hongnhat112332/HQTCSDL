...
--------------lap8---------------
/*câu 1: Viết thủ tục thêm mới nhân viên bao gồm các tham số: manv, tennv, gioitinh, diachi, sodt, email, phong và 1 biến Flag. Nếu Flag = 0 thì nhập mới, ngược lại thì cập nhật thông tin nhân viên theo mã. Hãy kiểm tra:
...
exec dbo.spThemMoiNhanVien 'NV04','Do Phu Thanh Dat','nam','Ho Chi Minh','03212345678','dat@gmail.com','Vat Tu','0'

/*câu 2: Viết thủ tục thêm mới sản phẩm với các tham biến masp, tenhang, tensp, soluong, mausac, giaban, donvitinh, mota và biến Flag. Nếu Flag = 0 thì thêm mới sản phẩm, ngược lại cập nhật sản phẩm. Hãy kiểm tra:
...
exec dbo.spThemMoiSanPham 'SP06','H03','SamSung note 9',-1,'trang',5000000,'chiec','','0'

/*câu 3:  Viết thủ tục xóa dữ liệu bảng nhanvien với tham biến là manv. Nếu manv chưa có thì trả về 1, 
ngược lại xóa nhanvien với nhanvien bị xóa là manv và trả về 0. 
(Lưu ý: xóa nhanvien thì phải xóa các bảng Nhap, Xuat mà sanpham này cung ứng.*/
...
exec dbo.spxoanhanvien 'NV04'

/*câu 4 Viết thủ tục xóa dữ liệu bảng sanpham với tham biến là masp.
...
exec dbo.spxoasanpham 'SP06'

/* câu 5: Tạo thủ tục nhập liệu cho bảng Hangsx,
 với các tham biến truyền vào mahangsx, tenhang, diachi, sodt, email. Hãy kiểm tra xem tenhang đã tồn tại trước đó hay chưa, nếu rồi trả về mã lỗi 1? 
Nếu có rồi thì không cho nhập và trả về mã lỗi 0*/
